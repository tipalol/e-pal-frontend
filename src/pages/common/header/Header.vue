  ...
  <header class="flex justify-between items-center p-4">
    <div class="flex items-center space-x-4">
      ...
      <nav class="hidden md:flex space-x-4">
        <a href="#" class="text-gray-300 hover:text-white text-[20px]">Play</a>
        <router-link href="#" class="text-gray-300 hover:text-white  text-[20px]" to="/">ePals</router-link>
        <a href="#" class="text-gray-300 hover:text-white  text-[20px]">Community</a>
      </nav>
    </div>
